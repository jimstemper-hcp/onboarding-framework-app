...
- Escalation Triggers: can't find customer, customer data missing, duplicate customers, merge customers`,
    ...
    // =========================================================================
    // ENGAGED - Pro is actively using customer management
    // =========================================================================
    engaged: {
      accessConditions: {
        operator: 'AND',
      ...
      contextSnippets: [
        {
          id: 'power-user',
          title: 'Power User',
          content: 'You\'re managing customers like a pro! Consider parent/child billing for commercial clients with multiple locations.',
        },
        {
          id: 'advanced-tip',
          title: 'Advanced Tip',
          content: 'Use customer notes and custom fields to track important details. Set up cards on file for faster checkout.',
        },
      ],

      navigation: [
        {
          name: 'Parent/Child Billing Guide',
          description: 'Managing commercial accounts with multiple locations',
          url: 'https://help.housecallpro.com/parent-child-billing',
          navigationType: 'hcp_help',
        },
        {
          name: 'Cards on File Tutorial',
          description: 'Video on setting up stored payment methods',
          url: 'https://www.youtube.com/watch?v=hcp-cards-on-file',
          navigationType: 'hcp_video',
        },
        {
          name: 'Customers',
      ...
      calendlyTypes: [
        {
          ...
          url: 'https://calendly.com/hcp-success/review',
          team: 'support',
          description: 'Review your customer management strategy',
        },
      ],
...
2. Offer to help with advanced features:
   - "Would you like to set up parent/child billing for commercial clients?"
   - "Would you like to enable cards on file for faster checkout?"
   - "Would you like to see your customer analytics and insights?"
3. Help them optimize their customer management workflow

Advanced features to highlight:
- Parent/child billing for commercial accounts
- Cards on file for repeat customers
...
## Chat Experience
When the user asks about customers at this stage:
- Response: "You're managing customers like a pro! Here are some advanced tips."
- Priority Action: tip
- Suggested CTA: "View Analytics" - Would you like to see your customer insights? You can also set up parent/child billing for commercial accounts or enable cards on file for faster checkout.
- Escalation Triggers: customer data export, bulk delete, account migration, GDPR request`,
      ...
      tools: [
        ...
        },
        {
          ...
          parameters: {
            ...
            state: { type: 'string', description: 'State abbreviation' },
            zip: { type: 'string', description: 'ZIP code' },
            parent_customer_id: { type: 'string', description: 'Parent customer ID for child billing' },
          },
        },
        {
          name: 'hcp_get_customer_analytics',
        ...
        {
          name: 'hcp_setup_card_on_file',
          description: 'Set up card on file for a customer',
          parameters: {
            customer_id: { type: 'string', description: 'Customer ID', required: true },
          },
        },
