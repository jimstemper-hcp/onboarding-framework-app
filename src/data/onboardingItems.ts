...
export const onboardingItems: OnboardingItemDefinition[] = [
  ...
  // ===========================================================================
  {
    ...
    completionCondition: {
      variable: 'customers_count',
      operator: 'gt',
      value: 1,
      description: 'Pro has more than 1 customer (sample customer excluded)',
    },
    estimatedMinutes: 2,
  ...
  },
  {
    ...
    completionCondition: {
      ...
      operator: 'gt',
      value: 0,
      description: 'Pro has at least 1 job',
    },
    estimatedMinutes: 3,
    actionUrl: '/jobs/new',
    points: 100,
  },
  {
    ...
    completionCondition: {
      variable: 'completed_jobs_count',
      operator: 'gt',
      value: 0,
      description: 'Pro has completed at least 1 job',
    },
    estimatedMinutes: 1,
    actionUrl: '/jobs',
    points: 75,
  ...
  // ===========================================================================
  {
    ...
    completionCondition: {
      variable: 'sent_invoices_count',
      operator: 'gt',
      value: 0,
      description: 'Pro has sent at least 1 invoice',
    },
    estimatedMinutes: 2,
    actionUrl: '/invoices',
    points: 100,
  ...
  },
  {
    ...
    completionCondition: {
      ...
      operator: 'gt',
      value: 1,
      description: 'Pro has more than 1 employee (owner excluded)',
    },
    estimatedMinutes: 3,
    actionUrl: '/team/new',
    points: 50,
  ...
  },
  {
    ...
    completionCondition: {
      variable: 'estimates_count',
      operator: 'gt',
      value: 0,
      description: 'Pro has at least 1 estimate',
    },
    estimatedMinutes: 3,
